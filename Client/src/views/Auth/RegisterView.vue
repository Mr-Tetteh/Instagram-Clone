  ...
  <div class="p-4 lg:p-2">
    <div
      ...
      <form class="border-solid " @submit.prevent="login">
        ...
        <div class="mt-3">
          <input id="email" type="tel" autocomplete="email" required placeholder="Mobile Number"
                 class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
        </div>
        ...
        <div class="mt-3">
          <input id="email" type="text" autocomplete="email" required placeholder="Full Name"
                 class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
        </div>

        <div class="mt-3">
          <input id="email" type="text" autocomplete="email" required placeholder="Username"
                 class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
        </div>
    ...
    <div class=" sm:mx-auto sm:w-full sm:max-w-sm border border-gray-300 rounded-lg p-5 shadow-lg bg-white">

      <p class=" text-center text-sm">
        Have an account?
        <router-link to="register" class="leading-6 text-sky-500 hover:text-indigo-500">Login</router-link>
      </p>
    </div>
  </div>
